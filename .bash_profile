...
# Update /etc/hosts.
alias update='brew update; brew upgrade; brew cleanup; npm update npm -g; npm update -g; rvm requirements; rvm get head; rvm requirements; rvm install 2.0.0; rvm use 2.0.0; rvm default 2.0.0; gem update; wget -N -P ~/Projects/dotfiles http://someonewhocares.org/hosts/hosts; dscacheutil -flushcache'
