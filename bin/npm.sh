...
EOF
  ...
  source /etc/profile
  npm i -g npm@latest
  npm install -g homebridge homebridge-lutron-caseta-smockle homebridge-mi-airpurifier homebridge-roomba-stv miio homebridge-harmony homebridge-harmony-tv-smockle-temp
fi
