...
if [ $SERVER -eq 0 ]; then
  yarn global add homebridge homebridge-ring homebridge-mi-airpurifier homebridge-smartthings-v2 homebridge-harmony-tv-smockle homebridge-platform-orbit
fi
